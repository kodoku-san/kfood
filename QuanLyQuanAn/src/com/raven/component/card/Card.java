package com.raven.component.card;
...
public class Card extends javax.swing.JPanel {
    ...
    public Card() {
        initComponents();
        setOpaque(false);
        gradientColor = new Color(16, 79, 181);
        setBackground(new Color(219,104,108));
    }
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/icons8-money-64.png"))); // NOI18N

        lbTitle.setFont(new java.awt.Font("sansserif", 1, 20)); // NOI18N
        lbTitle.setForeground(new java.awt.Color(255, 255, 153));
        lbTitle.setText("Title");

        lbDescription.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        lbDescription.setForeground(new java.awt.Color(255, 255, 153));
        lbDescription.setText("Description");
        lbDescription.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 10, 1));

        lbValues.setFont(new java.awt.Font("sansserif", 1, 17)); // NOI18N
        lbValues.setForeground(new java.awt.Color(255, 255, 153));
        lbValues.setText("0");
